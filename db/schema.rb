...
ActiveRecord::Schema[8.1].define(version: 20_251_119_083_811) do
  ...
  create_table 'deduction_types', force: :cascade do |t|
    ...
    t.string 'calculation_type', default: 'percentage', null: false,
    ...
    t.decimal 'employee_contribution', precision: 10, scale: 2, default: '0.0', null: false,
                                       comment: "Employee's contribution rate (percentage) or fixed amount (RM)"
    t.decimal 'employer_contribution', precision: 10, scale: 2, default: '0.0', null: false,
                                       comment: "Employer's contribution rate (percentage) or fixed amount (RM)"
    ...
    t.index %w[code effective_until], name: 'index_deduction_types_on_code_and_effective_until'
  ...
  create_table 'pay_calculation_details', force: :cascade do |t|
    t.datetime 'created_at', null: false
    t.string 'currency', default: 'RM'
    t.jsonb 'deduction_breakdown',
            comment: 'JSON breakdown of deductions: {EPF: {worker: 0, employee: 0}, SOCSO: {...}}'
    t.decimal 'deductions', precision: 10, scale: 2
    t.decimal 'employee_deductions', precision: 10, scale: 2, default: '0.0', null: false,
                                     comment: "Employee's total deductions (deducted from salary)"
    t.decimal 'employer_deductions', precision: 10, scale: 2, default: '0.0', null: false,
                                     comment: "Employer's total contributions (company cost)"
  ...
  create_table 'roles_permissions', force: :cascade do |t|
    ...
    t.index %w[role_id permission_id], name: 'index_roles_permissions_on_role_id_and_permission_id', unique: true
  ...
  create_table 'work_order_histories', force: :cascade do |t|
    ...
    t.index %w[work_order_id created_at], name: 'index_work_order_histories_on_order_and_created'
  ...
  create_table 'work_order_rates', force: :cascade do |t|
    ...
    t.string 'work_order_rate_type', default: 'normal',
  ...
  create_table 'work_orders', force: :cascade do |t|
    ...
    t.index %w[block_id work_order_rate_id], name: 'index_work_orders_on_block_and_rate'
